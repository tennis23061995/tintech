 ...
 */
    //文章搜索
        $("#search_article").on('click',function(){
            ...
            window.location.href="/admin/video/index?page=1&pagesize=10&search="+searchTxt;
        })
        $("#markselect").on('change',function(){
            var filter=$(this).val();
            window.location.href="/admin/video/index?page=1&pagesize=10&type="+filter;
        })
