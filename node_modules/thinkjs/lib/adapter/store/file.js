...
var _class = function (_think$adapter$base) {
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              _context.next = 5;
              return lockFiles[filePath];

            case 5:
              return _context.abrupt('return', think.promisify(_fs2.default.readFile, _fs2.default)(filePath, { encoding: 'utf8' }));
  ...
  _class.prototype.set = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(key, content) {
      var filePath, fn, promise;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              promise = fn(filePath, content).then(function () {
