...
var _class = function (_Base) {
  ...
  _class.prototype.perlistAction = function () {
    var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5() {
      var tagList, rolePermissions, arr, i, ilist, obj, prr, pbj, j, newArr, roleArr, item, k;
      return _regenerator2.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return this.model('admin').findAll('manage_tag');

            case 2:
              tagList = _context5.sent;
              _context5.next = 5;
              return this.model('admin').findOne('manage_role', { id: this.get('id') });

            case 5:
              rolePermissions = _context5.sent;
              arr = [];
              _context5.t0 = _regenerator2.default.keys(tagList);
            ...
            case 8:
              ...
              ilist = {}, obj = {};
              _context5.next = 13;
              return this.model('admin').findAll('manage_permission', { tag: tagList[i].id });

            case 13:
              ilist = _context5.sent;
              prr = [], pbj = {};
              //循环权限
    ...
    function perlistAction() {
      return _ref5.apply(this, arguments);
    }

    return perlistAction;
  }();

  _class.prototype.rolesaveAction = function () {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              _context6.next = 7;
              return this.model('admin').updateRecord('manage_role', { id: this.post('id') }, newdata);
    ...
    function rolesaveAction() {
      return _ref6.apply(this, arguments);
    }

    return rolesaveAction;
  }();
