...
var _class = function (_Base) {
  ...
  _class.prototype.getIndex = function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(info) {
      var itemList, result, Page, page, pageData;
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.model('admin').getRoleJoinRecord({ manage_tag: { on: "tag, id" } }, info.page, info.pagesize);

            case 2:
              itemList = _context.sent;
              _context.next = 5;
              return this.model(info.db).page(info.page, info.pagesize).countSelect();
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              _context3.next = 6;
              return this.model('manage_tag').select();
