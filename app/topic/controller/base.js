...
var _class = function (_think$controller$bas) {
        ...
        _class.prototype.__before = function () {
                var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
                        var _web, csrf, uinfo, islogin, logininfo, tagList, memberList, lstparentmenu, navList, i, submenu, submenusid, j;
                        ...
                        return _regenerator2.default.wrap(function _callee$(_context) {
                                while (1) {
                                        switch (_context.prev = _context.next) {
                                                ...
                                                case 18:
                                                        _context.next = 20;
                                                        return this.model('topic').findAll('tags', { appear: 1 });
                                                ...
                                                case 20:
                                                        ...
                                                        // 获取最新会员
                                                        _context.next = 24;
                                                        return this.model("topic").getMemberList({ role: 4 }, 9);
                        ...
                        return _regenerator2.default.wrap(function _callee2$(_context2) {
                                while (1) {
                                        switch (_context2.prev = _context2.next) {
                                                case 0:
                                                        _context2.next = 2;
                                                        return this.model('topic').findOne('system', { id: 1 });
